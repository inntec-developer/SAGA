    ...
    public partial class checkDatabase : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("BTra.AreasExperiencia", t => t.AreaExperienciaId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("sist.Personas", t => t.PersonaId, cascadeDelete: true)
                .ForeignKey("sist.TiposTelefonos", t => t.TipoTelefonoId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("BTra.InstitucionesEducativas", t => t.InstitucionEducativaId, cascadeDelete: true)
                .ForeignKey("sist.Months", t => t.MonthInicioId)
                .ForeignKey("sist.Months", t => t.MonthTerminoId)
                .ForeignKey("BTra.PerfilCandidato", t => t.PerfilCandidatoId, cascadeDelete: true)
                .ForeignKey("sist.Years", t => t.YearInicioId)
            ...
            CreateTable(
                ...
                .ForeignKey("sist.GiroEmpresas", t => t.GiroEmpresaId, cascadeDelete: true)
                .ForeignKey("sist.Months", t => t.MonthInicioId, cascadeDelete: true)
                .ForeignKey("sist.Months", t => t.MonthTerminoId, cascadeDelete: true)
                .ForeignKey("BTra.PerfilCandidato", t => t.PerfilCandidatoId, cascadeDelete: true)
                .ForeignKey("sist.Years", t => t.YearInicioId, cascadeDelete: true)
                .ForeignKey("sist.Years", t => t.YearTerminoId, cascadeDelete: true)
                .Index(t => t.GiroEmpresaId)
                .Index(t => t.AreaId)
                .Index(t => t.YearInicioId)
                .Index(t => t.MonthInicioId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("BTra.Carreras", t => t.CarreraId, cascadeDelete: true)
                ...
                .ForeignKey("sist.GradosEstudios", t => t.GradoEstudioId, cascadeDelete: true)
                .ForeignKey("BTra.InstitucionesEducativas", t => t.InstitucionEducativaId, cascadeDelete: true)
                .ForeignKey("sist.Months", t => t.MonthInicioId)
                .ForeignKey("sist.Months", t => t.MonthTerminoId)
                .ForeignKey("BTra.PerfilCandidato", t => t.PerfilCandidatoId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("sist.Niveles", t => t.NivelEscritoId, cascadeDelete: true)
                .ForeignKey("sist.Niveles", t => t.NivelHabladoId, cascadeDelete: true)
                .ForeignKey("BTra.PerfilCandidato", t => t.PerfilCandidatoId, cascadeDelete: true)
                .Index(t => t.IdiomaId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        TiempoContratoId = c.Int(),
                        Activo = c.Boolean(nullable: false),
                        fch_Creacion = c.DateTime(nullable: false),
                        fch_Modificacion = c.DateTime(),
                        FlexibilidadHorario = c.Boolean(nullable: false),
                        JornadaLaboralId = c.Int(),
                        TipoModalidadId = c.Int(),
                        UsuarioAlta = c.Guid(nullable: false),
                        UsuarioMod = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("sist.Areas", t => t.AreaId, cascadeDelete: true)
                .ForeignKey("Recl.ClasesReclutamientos", t => t.ClaseReclutamientoId, cascadeDelete: true)
                .ForeignKey("Vtas.Clientes", t => t.ClienteId)
                .ForeignKey("sist.TiposContratos", t => t.ContratoInicialId, cascadeDelete: true)
                .ForeignKey("Recl.DiasSemana", t => t.DiaCorteId, cascadeDelete: true)
                .ForeignKey("Recl.DiasSemana", t => t.DiaPagoId, cascadeDelete: true)
                ...
                .ForeignKey("sist.JornadasLaborales", t => t.JornadaLaboralId)
                .ForeignKey("Recl.PeriodosPagos", t => t.PeriodoPagoId, cascadeDelete: true)
                .ForeignKey("sist.TiemposContratos", t => t.TiempoContratoId)
                .ForeignKey("sist.TiposModalidades", t => t.TipoModalidadId)
                .ForeignKey("sist.TiposNominas", t => t.TipoNominaId, cascadeDelete: true)
                .ForeignKey("sist.TiposReclutamientos", t => t.TipoReclutamientoId, cascadeDelete: true)
                .Index(t => t.ClienteId)
                ...
                .Index(t => t.TiempoContratoId)
                .Index(t => t.JornadaLaboralId)
                .Index(t => t.TipoModalidadId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("sist.CompetenciasAreas", t => t.CompetenciaId, cascadeDelete: true)
                .ForeignKey("Recl.DAMFO_290", t => t.DAMFO290Id, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("sist.CompetenciasCardinales", t => t.CompetenciaId, cascadeDelete: true)
                .ForeignKey("Recl.DAMFO_290", t => t.DAMFO290Id, cascadeDelete: true)
                .Index(t => t.CompetenciaId)
                .Index(t => t.DAMFO290Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("sist.CompetenciasGerenciales", t => t.CompetenciaId, cascadeDelete: true)
                .ForeignKey("Recl.DAMFO_290", t => t.DAMFO290Id, cascadeDelete: true)
                .Index(t => t.CompetenciaId)
                .Index(t => t.DAMFO290Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("Recl.DiasSemana", t => t.aDiaId, cascadeDelete: true)
                .ForeignKey("Recl.DAMFO_290", t => t.DAMFO290Id, cascadeDelete: true)
                .ForeignKey("Recl.DiasSemana", t => t.deDiaId, cascadeDelete: true)
                .Index(t => t.deDiaId)
                .Index(t => t.aDiaId)
                .Index(t => t.DAMFO290Id);
            
            CreateTable(
                "sist.JornadasLaborales",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("Recl.DAMFO_290", t => t.DAMFO290Id, cascadeDelete: true)
                .ForeignKey("sist.TiposPsicometrias", t => t.PsicometriaId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        TiempoContratoId = c.Int(),
                        fch_Creacion = c.DateTime(nullable: false),
                        fch_Aprobacion = c.DateTime(nullable: false),
                        fch_Cumplimiento = c.DateTime(nullable: false),
                        fch_Modificacion = c.DateTime(nullable: false),
                ...
                .ForeignKey("Recl.ClasesReclutamientos", t => t.ClaseReclutamientoId, cascadeDelete: true)
                .ForeignKey("Vtas.Clientes", t => t.ClienteId)
                .ForeignKey("sist.TiposContratos", t => t.ContratoFinal_Id)
                .ForeignKey("sist.TiposContratos", t => t.ContratoInicialId, cascadeDelete: true)
                .ForeignKey("Recl.DAMFO_290", t => t.DAMFO290Id, cascadeDelete: true)
                .ForeignKey("Recl.DiasSemana", t => t.DiaCorteId, cascadeDelete: true)
                .ForeignKey("Recl.DiasSemana", t => t.DiaPagoId, cascadeDelete: true)
                ...
                .ForeignKey("sist.EstadosCiviles", t => t.EstadoCivilId, cascadeDelete: true)
                .ForeignKey("sist.Estatus", t => t.EstatusId)
                .ForeignKey("sist.Generos", t => t.GeneroId, cascadeDelete: true)
                .ForeignKey("sist.JornadasLaborales", t => t.JornadaLaboralId)
                .ForeignKey("Recl.PeriodosPagos", t => t.PeriodoPagoId, cascadeDelete: true)
                .ForeignKey("sist.Prioridades", t => t.PrioridadId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("BTra.Candidatos", t => t.CandidatoId)
                .ForeignKey("Vtas.Requisiciones", t => t.RequisicionId, cascadeDelete: true)
                .ForeignKey("BTra.StatusPostulaciones", t => t.StatusId, cascadeDelete: true)
                .Index(t => t.CandidatoId)
                .Index(t => t.RequisicionId)
                .Index(t => t.StatusId);
            ...
            CreateTable(
                ...
                .ForeignKey("sist.Paises", t => t.PaisNacimientoId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("sist.Personas", t => t.Id)
                .ForeignKey("sist.GiroEmpresas", t => t.GiroEmpresaId, cascadeDelete: true)
                .ForeignKey("Vtas.ActividadEmpresas", t => t.ActividadEmpresaId, cascadeDelete: true)
                .ForeignKey("sist.TamanosEmpresas", t => t.TamanoEmpresaId, cascadeDelete: true)
                .ForeignKey("sist.TiposEmpresas", t => t.TipoEmpresaId, cascadeDelete: true)
                .ForeignKey("sist.TiposBases", t => t.TipoBaseId, cascadeDelete: true)
                .Index(t => t.Id)
                .Index(t => t.GiroEmpresaId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("Vtas.Clientes", "TipoBaseId", "sist.TiposBases");
            DropForeignKey("Vtas.Clientes", "TipoEmpresaId", "sist.TiposEmpresas");
            DropForeignKey("Vtas.Clientes", "TamanoEmpresaId", "sist.TamanosEmpresas");
            ...
            DropForeignKey("Vtas.Requisiciones", "TipoReclutamientoId", "sist.TiposReclutamientos");
            DropForeignKey("Vtas.Requisiciones", "TipoNominaId", "sist.TiposNominas");
            ...
            DropForeignKey("Vtas.PsicometriasDamsaRequi", "PsicometriaId", "sist.TiposPsicometrias");
            ...
            DropForeignKey("Vtas.EscolaridadesRequi", "EstadoEstudioId", "sist.EstadosEstudios");
            ...
            DropForeignKey("Vtas.Requisiciones", "ContratoInicialId", "sist.TiposContratos");
            ...
            DropForeignKey("Vtas.CompetenciasGerencialesRequi", "CompetenciaId", "sist.CompetenciasGerenciales");
            DropForeignKey("Vtas.CompetenciasCardinalesRequi", "RequisicionId", "Vtas.Requisiciones");
            DropForeignKey("Vtas.CompetenciasCardinalesRequi", "CompetenciaId", "sist.CompetenciasCardinales");
            DropForeignKey("Vtas.CompetenciasAreasRequi", "RequisicionId", "Vtas.Requisiciones");
            DropForeignKey("Vtas.CompetenciasAreasRequi", "CompetenciaId", "sist.CompetenciasAreas");
            ...
            DropForeignKey("Vtas.BeneficiosRequi", "TipoBeneficioId", "sist.TiposBeneficios");
            ...
            DropForeignKey("Recl.DAMFO_290", "TipoReclutamientoId", "sist.TiposReclutamientos");
            DropForeignKey("Recl.DAMFO_290", "TipoNominaId", "sist.TiposNominas");
            DropForeignKey("Recl.DAMFO_290", "TipoModalidadId", "sist.TiposModalidades");
            DropForeignKey("Recl.DAMFO_290", "TiempoContratoId", "sist.TiemposContratos");
            DropForeignKey("Recl.PsicometriasDamsa", "PsicometriaId", "sist.TiposPsicometrias");
            ...
            DropForeignKey("Recl.DAMFO_290", "JornadaLaboralId", "sist.JornadasLaborales");
            ...
            DropForeignKey("Recl.EscolaridadesPerfil", "EstadoEstudioId", "sist.EstadosEstudios");
            ...
            DropForeignKey("Recl.DAMFO_290", "ContratoInicialId", "sist.TiposContratos");
            DropForeignKey("Recl.CompetenciaGerencialPerfil", "DAMFO290Id", "Recl.DAMFO_290");
            DropForeignKey("Recl.CompetenciaGerencialPerfil", "CompetenciaId", "sist.CompetenciasGerenciales");
            DropForeignKey("Recl.CompetenciaCardinalPerfil", "DAMFO290Id", "Recl.DAMFO_290");
            DropForeignKey("Recl.CompetenciaCardinalPerfil", "CompetenciaId", "sist.CompetenciasCardinales");
            DropForeignKey("Recl.CompetenciaAreaPerfil", "DAMFO290Id", "Recl.DAMFO_290");
            DropForeignKey("Recl.CompetenciaAreaPerfil", "CompetenciaId", "sist.CompetenciasAreas");
            ...
            DropForeignKey("Recl.BeneficiosPerfil", "TipoBeneficioId", "sist.TiposBeneficios");
            ...
            DropForeignKey("BTra.Formaciones", "EstadoEstudioId", "sist.EstadosEstudios");
            ...
            DropTable("sist.TiposModalidades");
            DropTable("sist.TiemposContratos");
            ...
            DropTable("sist.JornadasLaborales");
