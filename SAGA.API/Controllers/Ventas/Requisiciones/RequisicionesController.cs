           ...
           string ffin, string emp, string sol, string trcl, string cor, string stus, string recl)
        {
            ...
            try
            {
                ...
                var objeto = vacantes.OrderByDescending(o => o.fch_Creacion).Select(e => new
                {
                    ...
                    EstatusId = requi.Where(x => x.Id == e.Id).Select(a => a.EstatusId).FirstOrDefault(),
        ...
        public IHttpActionResult ExecProcedurePause()
        {
            ...
            try
            {
                ...
                if (datos.Count > 0)
                {
                    ...
                    //var datos = from R in db.Requisiciones
                    //            where R.EstatusId.Equals(39) && (DateTime.Now.DayOfYear - R.fch_Modificacion.Value.DayOfYear) >= 3
                    //            select new
                    //            {
                    //                requisicionId = R.Id,
                    //                folio = R.Folio,
                    ...
                    //                dias = DateTime.Now.DayOfYear - R.fch_Modificacion.Value.DayOfYear
                    //            };

                    //                  var datos = db.Requisiciones.Where(x => x.EstatusId.Equals(39) && (DateTime.Now.Day - x.fch_Modificacion.Value.Day) >= 3).Select( R => new
                    //{
                    //    requisicionId = R.Id,
                    //    folio = R.Folio,
                    //    vBtra = R.VBtra,
