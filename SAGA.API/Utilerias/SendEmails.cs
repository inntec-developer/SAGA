        ...
        */
        ...
        public void ConstructEmail(List<AsignacionRequi> asignaciones, List<AsignacionRequi> NotChange, string action, int Folio, string Usuario, string VBr)
        {
            ...
            if(distintEmails.Count() > 0)
            {
                ...
                if (action == "C")
                {
                    m.Subject = "Asignacion de Requisicion";
                    ...
                    body = body + "<p>Para ver tus requisiciones asignadas ingresa a tu panel de reclutamiento y selecciona la opción de requisiciones, para dar el seguimiento correspondiente.</p> ";
